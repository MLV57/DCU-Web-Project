...
insert into groupH_discussion_table (title, tags, creation_date, topic_id) values ("is AI a danger for humanity ?", "Computer Sciences;Machine Learning", "2021-04-23 15:02:23", 2);
...
insert into groupH_discussion_table (title, tags, creation_date, topic_id) values ("Would you agree to travel in an autonomous car ?", "Autonomous car", "2021-04-23 10:47:12",2);
insert into groupH_discussion_table (title, tags, creation_date, topic_id) values ("Is the Internet of Things the future ?", "Engineering; IoT", "2021-04-23 10:13:12",2);
insert into groupH_discussion_table (title, tags, creation_date, topic_id) values ("Can Near Field Communication change the biomedical space ?", "Engineering; Biomedical; NFCr", "2021-04-23 10:19:12",1);
insert into groupH_discussion_table (title, tags, creation_date, topic_id) values ("Will Elon Musk get to Mars ?", "SpaceX; space; mars", "2021-04-23 15:56:23",2);
